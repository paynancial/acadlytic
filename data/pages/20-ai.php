...
return [
    ...
    '/ai/ai-for-admissions/' => [
        ...
        'blocks' => [
            ...
            faq([
                'Does AI decide which applicants are admitted?' => 'No. Acadlytic AI prioritises follow-ups, summarises histories and drafts replies. Selection decisions stay with people and your published criteria.',
    ...
    '/ai/ai-for-student-success/' => [
        ...
        'blocks' => [
            ...
            faq([
                ...
                'Are sensitive attributes used in early-warning models?' => 'No. Sensitive attributes are excluded, and flag rates are reviewed across student groups to detect unfair patterns.',
                'Who sees early-warning flags?' => 'Only designated support roles, and flags show contributing factors rather than a permanent label.',
            ]),
        ],
    ...
    '/ai/ai-recommendations/' => [
        ...
        'blocks' => [
            ...
            faq([
                ...
                'Can staff ignore a recommendation?' => 'Yes. Staff can accept, modify or dismiss any recommendation, and their feedback improves future suggestions.',
            ]),
        ],
    ...
    '/ai/ai-personalization/' => [
        ...
        'blocks' => [
            ...
            faq([
                ...
                'Can students control personalisation?' => 'Yes. Students can see and adjust their stated preferences, and opt-outs are always respected.',
            ]),
        ],
    ...
    '/ai/ai-workflows/' => [
        ...
        'blocks' => [
            ...
            faq([
                ...
                'Can AI steps be switched off?' => 'Yes. Administrators can disable AI steps per workflow at any time without breaking the rest of the process.',
            ]),
        ],
    ...
    '/ai/ai-search/' => [
        ...
        'blocks' => [
            ...
            faq([
                'How does AI search understand my question?' => 'It interprets the intent of a query, converts it into structured filters and shows the filters it applied so you can adjust them.',
                'Can AI search reveal records I cannot access?' => 'No. Results respect the same record- and field-level permissions as the rest of the platform.',
            ]),
        ],
    ...
    '/ai/ai-document-intelligence/' => [
        ...
        'blocks' => [
            ...
            faq([
                ...
                'Does document intelligence verify authenticity?' => 'No. It pre-checks type, quality and consistency. Staff verify each document, and formal authenticity checks follow your procedures.',
            ]),
        ],
    ...
    '/ai/ai-predictive-analytics/' => [
        ...
        'blocks' => [
            ...
            faq([
                ...
                'Are predictions used to make decisions about individual students?' => 'No. Forecasts inform planning. They never decide individual admissions or outcomes.',
            ]),
        ],
    ...
    '/ai/ai-communications/' => [
        ...
        'blocks' => [
            ...
            faq([
                ...
                'Will AI messages go out automatically?' => 'No. A person approves every AI-assisted message, and all messages follow the Communication Hub’s consent rules.',
            ]),
        ],
    ...
    '/ai/responsible-ai/' => [
        ...
        'blocks' => [
            ...
            faq([
                ...
                'Can an institution turn off AI features?' => 'Yes. Each AI feature can be enabled, configured or disabled by role or department.',
