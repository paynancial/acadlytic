...
return [
    ...
    '/platform/post-secondary-school-database/' => [
        ...
        'blocks' => [
            ...
            faq([
                'What information does the post-secondary database hold?' => 'Structured details for institutions and programmes, including location, level, entry requirements, duration, study mode, indicative fees and application windows.',
                'How current is the programme information?' => 'Each entry records its source and the date it was last verified, and counselling teams can flag outdated details for update.',
            ]),
        ],
    ...
    '/platform/electronic-document-sharing/' => [
        ...
        'blocks' => [
            ...
            faq([
                'Which file types can students upload?' => 'Institutions choose the allowed formats and size limits for each document type, and uploads are checked before storage.',
                'How are certificates shared securely?' => 'Through time-limited links rather than email attachments, with every view and download logged.',
            ]),
        ],
    ...
    '/platform/completion-tracking/' => [
        ...
        'blocks' => [
            ...
            faq([
                'What does completion tracking monitor?' => 'Credits earned against requirements, mandatory components, programme milestones and clearances needed before graduation.',
                'When are advisors alerted?' => 'When a student meets the institution’s own definition of “off track” for their programme, with the specific gap explained in the task.',
            ]),
        ],
    ...
    '/platform/student-engagement/' => [
        ...
        'blocks' => [
            ...
            faq([
                ...
                'Is engagement data used to penalise students?' => 'It should not be. Acadlytic is designed for engagement data to prompt support and outreach, not sanctions.',
            ]),
        ],
    ...
    '/platform/enrollment-analytics/' => [
        'title' => 'Enrolment Analytics Software',
        ...
        'blocks' => [
            ...
            faq([
                'What is enrolment analytics?' => 'Analysis of the recruitment funnel from enquiry to enrolment, by stage, source, programme and counsellor, compared with previous cycles.',
                'How accurate are enrolment forecasts?' => 'Forecasts are shown as ranges with stated assumptions, and their accuracy is reported at the end of each cycle.',
            ]),
        ],
        'related' => ['/ai/ai-predictive-analytics/', '/platform/admissions-crm/', '/platform/reports-insights/', '/glossary/yield-rate/', '/glossary/education-analytics/'],
    ],
];
