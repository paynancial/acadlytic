...
return [
    '/integrations/' => [
        ...
        'lead'  => 'Acadlytic connects to the systems you keep through documented APIs, event webhooks and scheduled exports, so data flows once and stays consistent.',
        'groups' => [
    ...
    '/integrations/sis-integration/' => [
        ...
        'lead'  => 'Keep your existing SIS as the system of record, or phase it out gradually. Either way, Acadlytic keeps student data consistent across both.',
        'icon'  => 'database',
        'blocks' => [
            sec('Two common approaches',
                'Some institutions keep their SIS for records and results and use Acadlytic for CRM, communication, engagement and analytics. Others adopt Acadlytic’s student management and migrate away from the SIS over time. The integration pattern differs for each.'),
            table('Typical data flows', ['Data', 'Direction when SIS is the record', 'Frequency'], [
            ...
            faq([
                'Do we have to replace our SIS?' => 'No. Many institutions keep their SIS as the system of record and integrate it with Acadlytic. Others migrate over time. We help you choose.',
    ...
    '/integrations/lms-integration/' => [
        ...
        'lead'  => 'Your LMS delivers learning. Acadlytic runs operations. Integration keeps course enrolments aligned and brings learning activity into student support.',
        'icon'  => 'book',
        'blocks' => [
            table('What typically flows', ['Data', 'Direction', 'Why'], [
            ...
            faq([
                ...
                'Will faculty have to enter grades twice?' => 'Not where grade sync is configured. Grades entered in the LMS can flow to Acadlytic for consolidation and moderation.',
            ]),
        ],
    ...
    '/integrations/erp-integration/' => [
        ...
        'lead'  => 'Acadlytic manages student-facing finance. Your ERP keeps the books. Integration posts the right summaries across without re-keying.',
        'icon'  => 'layers',
        'blocks' => [
            sec('Dividing responsibilities',
                'ERP systems excel at general ledger, procurement, payroll and HR. They are rarely designed for student-level fee plans, concessions and parent-friendly receipts. The cleanest pattern keeps student billing in Acadlytic and posts summarised, reconciled entries to the ERP.'),
            table('Typical flows', ['Data', 'Direction'], [
            ...
            faq([
                'Do we still need our ERP?' => 'Usually yes, for the general ledger, payroll, HR and procurement. Acadlytic handles student-facing finance and posts summaries to the ERP.',
    ...
    '/integrations/crm-integration/' => [
        ...
        'lead'  => 'Some institutions already use an enterprise CRM or marketing automation platform for campaigns. Acadlytic can work alongside it, sharing contacts and outcomes.',
        'icon'  => 'users',
        'blocks' => [
            ...
            faq([
                'Should we keep our existing CRM?' => 'It depends on how well it serves admissions and student teams today. Many institutions keep marketing tools and move admissions workflows into Acadlytic.',
    ...
    '/integrations/sso-integration/' => [
        ...
        'blocks' => [
            ...
            faq([
                'Can students use SSO too?' => 'Yes, if students have institutional accounts in your identity provider. Otherwise they can use Acadlytic credentials.',
    ...
    '/integrations/payment-integration/' => [
        ...
        'blocks' => [
            steps('Payment flow', [
                'Invoice' => 'Acadlytic issues an invoice or payment request with a secure payment link.',
            ...
            faq([
                'Does Acadlytic store card details?' => 'No. Payment details are entered on the gateway’s hosted page. Acadlytic receives only the payment confirmation and reference.',
                'Can parents pay on behalf of students?' => 'Yes. Payment links can be shared with linked parent or guardian contacts, and receipts go to the payer and the student record.',
    ...
    '/integrations/email-integration/' => [
        ...
        'blocks' => [
            ...
            faq([
                'Will emails come from our own domain?' => 'Yes, once your IT team authorises Acadlytic to send on your behalf through SPF and DKIM records.',
                'Can staff reply from their own mailbox?' => 'Yes. Where mailbox logging is enabled, replies can be captured on the relevant record, subject to your privacy settings.',
            ]),
        ],
    ...
    '/integrations/whatsapp-integration/' => [
        ...
        'blocks' => [
            ...
            faq([
                'Do we need a WhatsApp Business account?' => 'Yes. Messaging runs through the WhatsApp Business Platform via a provider, using your institution’s verified business profile.',
                'Can we send messages to anyone with a phone number?' => 'Only to contacts who have opted in. Acadlytic records consent and prevents sending to contacts who have not opted in or have opted out.',
            ]),
        ],
    ...
    '/integrations/messaging-integration/' => [
        ...
        'lead'  => 'SMS remains the most universal channel for short, urgent messages. Acadlytic connects to messaging providers and adds in-app notifications for portal users.',
        'icon'  => 'bell',
        'blocks' => [
            cards('Channels', [
            ...
            sec('Regulatory considerations',
                'Commercial and transactional SMS are regulated in many countries, including sender registration, template approval and consent requirements. Acadlytic supports these through provider integrations; your institution remains responsible for the content and consent of messages it sends.'),
            checks('Best practices built in', [
            ...
            faq([
                'Do we need our own SMS provider?' => 'You can use a provider contracted by your institution or one arranged with us. Sender registration and template rules depend on your country.',
                'Can students choose SMS over email?' => 'Yes. Channel preferences are stored per contact and respected by the Communication Hub, except for designated emergency messages.',
    ...
    '/integrations/calendar-integration/' => [
        ...
        'icon'  => 'calendar',
        'blocks' => [
            table('What syncs', ['Item', 'Who sees it'], [
            ...
            faq([
                ...
                'Do students see other students’ appointments?' => 'No. Booking pages show only available time slots, never who booked the other slots.',
                'What happens when a class is moved?' => 'The change is published once in Acadlytic; subscribed calendars update and affected students are notified.',
            ]),
        ],
    ...
    '/integrations/api/' => [
        ...
        'desc'  => 'The Acadlytic REST API lets institutions and partners read and write platform data securely, with scoped credentials, rate limits, versioning and sandbox access.',
        'h1'    => 'The Acadlytic API',
        'nav_label' => 'REST API',
        'lead'  => 'Build your own integrations and tools on Acadlytic data with a REST API designed for security, stability and clear documentation.',
        'icon'  => 'code',
        'blocks' => [
            cards('Design principles', [
                ...
                'Scoped credentials' => 'API clients receive only the permissions they need, and can be revoked at any time.',
            ...
            note('API documentation and sandbox credentials are shared with customers and approved partners. [Contact us](/core/contact/?topic=partnership) to discuss access.'),
            faq([
                'Is there an API for our website forms?' => 'Yes. Enquiry and application endpoints let your website submit directly to Acadlytic, with validation and spam protection.',
    ...
    '/integrations/webhooks/' => [
        ...
        'lead'  => 'Instead of polling for changes, let Acadlytic tell your systems when something happens, with signed, retried event notifications.',
        'icon'  => 'link',
        'blocks' => [
            table('Example events', ['Event', 'Typical use'], [
            ...
            checks('Reliability and security', [
            ...
            faq([
                'What if our system is down when an event is sent?' => 'Deliveries are retried with increasing delays. Administrators can see failed deliveries and replay them once the receiver is available.',
    ...
    '/integrations/data-export/' => [
        ...
        'blocks' => [
            ...
            faq([
                'Can we feed our own data warehouse?' => 'Yes. Scheduled extracts or the API can feed your warehouse, with options to minimise personal data for analytics.',
