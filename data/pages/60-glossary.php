    ...
    '/glossary/outcome-based-education/' => [
        ...
        'blocks' => [
            ...
            sec('Why OBE matters in India',
                'Outcome-based approaches are central to program accreditation in India, particularly for engineering and other technical programs accredited by the National Board of Accreditation (NBA). NBA’s accreditation framework assesses programs on the outcomes students achieve; refer to the applicable [NBA accreditation manuals and materials](https://www.nbaind.org/accreditation) for the current requirements. Measuring attainment requires assessment marks to be linked to the course outcomes they test, which is difficult to do reliably in spreadsheets across many courses and years. See the [accreditation data guide](/resources/accreditation-data-guide/).'),
            faq([
    ...
    '/glossary/choice-based-credit-system/' => [
        ...
        'blocks' => [
            ...
            sec('Where the framework is set out',
                'CBCS is defined by the University Grants Commission. See the official [UGC guidelines on adopting the choice-based credit system](https://www.ugc.gov.in/pdfnews/9555132_Guidelines.pdf). UGC’s more recent [Curriculum and Credit Framework for Undergraduate Programmes](https://www.ugc.gov.in/Curriculum_and_Credit_Framework_for_Undergraduate_Programmes.aspx) also incorporates a flexible choice-based credit system. Frameworks are revised from time to time, so check the current UGC documents and your university’s own ordinances before relying on any detail.'),
            faq([
