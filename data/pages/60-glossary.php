...
return [
    ...
    '/glossary/outcome-based-education/' => [
        ...
        'blocks' => [
            ...
            sec('Why OBE matters in India',
                'Outcome-based approaches are central to program accreditation in India, particularly for engineering and other technical programs accredited by the National Board of Accreditation (NBA). NBA’s accreditation framework assesses programs on the outcomes students achieve; for how program outcomes, course outcomes and attainment are assessed, refer to NBA’s current [accreditation manual for undergraduate engineering programs (Tier I, 2026 edition)](https://www.nbaind.org/files/Manual%20for%20UG%20Engineering%20Tier%20I-%202026%20Edition_Format_20260521165316.pdf) and the manual that applies to your program type. Measuring attainment requires assessment marks to be linked to the course outcomes they test, which is difficult to do reliably in spreadsheets across many courses and years. See the [accreditation data guide](/resources/accreditation-data-guide/).'),
            faq([
    ...
    '/glossary/choice-based-credit-system/' => [
        ...
        'blocks' => [
            ...
            sec('Where the framework is set out',
                'CBCS was introduced by the University Grants Commission. UGC’s current [Curriculum and Credit Framework for Undergraduate Programmes](https://www.ugc.gov.in/KeyInitiative?ID=yiPY1rgAlvz9%2F1chFf86gg%3D%3D) carries the choice-based credit approach forward, with a flexible credit structure for undergraduate study. Frameworks are revised from time to time, so check the current UGC documents and your university’s own ordinances before relying on any detail.'),
            faq([
