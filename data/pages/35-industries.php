...
return [
    '/industries/' => [
        ...
        'lead'  => 'Institutions differ in size, funding, regulation and learners. Acadlytic’s configuration adapts to each while keeping one connected platform underneath.',
        'groups' => [
    ...
    '/industries/community-colleges/' => [
        ...
        'lead'  => 'Community colleges serve learners with diverse goals and busy lives. Acadlytic helps small teams enrol quickly, support students proactively and report outcomes clearly.',
        'blocks' => [
            ...
            faq([
                'Can Acadlytic handle students who pause and return?' => 'Yes. A student’s record keeps its full history through breaks in study, and returning learners can be re-enrolled without creating a duplicate record.',
                'Do we need a large IT team?' => 'No. Acadlytic is a managed cloud service. Most configuration is done by trained administrators, and integration work is scoped with you up front.',
                'Can short workforce courses sit alongside credit programmes?' => 'Yes. Programme structures can differ, so short non-credit courses and full qualifications can be managed on the same platform with separate rules.',
            ]),
        ],
    ...
    '/industries/private-institutions/' => [
        ...
        'lead'  => 'Private institutions compete for students and depend on fee income. Acadlytic strengthens recruitment, sharpens the student experience and keeps finances visible.',
        'blocks' => [
            ...
            table('Priorities and capabilities', ['Priority', 'Acadlytic capability'], [
            ...
            faq([
                ...
                'Can each programme have its own fee structure and concessions?' => 'Yes. Fee structures, instalments and concession rules are configured per programme, year and category, with approval workflows.',
                'Can we keep our brand consistent across departments?' => 'Yes. Approved templates for email, SMS and WhatsApp keep tone and branding consistent, and broadcast messages can require approval.',
            ]),
        ],
    ...
    '/industries/public-institutions/' => [
        ...
        'lead'  => 'Public institutions carry obligations of transparency, fairness and accountability. Acadlytic supports rule-based processes, auditable decisions and reliable statutory reporting.',
        'blocks' => [
            sec('Accountability built in',
            ...
            cards('Capabilities relevant to public institutions', [
            ...
            note('Selection rules and merit criteria are configured by the institution according to its published policies. Acadlytic applies them consistently; it does not make selection judgements.'),
            faq([
                'Can we publish merit lists from the platform?' => 'Ranked lists can be generated from the criteria your institution configures and exported for publication through your official channels, with an audit trail of how they were produced.',
                ...
                'Can applicants track grievances online?' => 'Yes. Grievances can be submitted and tracked, with every action recorded for accountability.',
            ]),
        ],
    ...
    '/industries/professional-education/' => [
        ...
        'lead'  => 'Professional education runs on short cycles, working learners and corporate relationships. Acadlytic manages individuals and organisations on one CRM.',
        'blocks' => [
            ...
            faq([
                'Can a company enrol a group of employees at once?' => 'Yes. Corporate accounts can register cohorts, and sponsors can receive consolidated invoices and progress reports.',
                'Do you support certificates for short programmes?' => 'Yes. Completion rules and certificate templates can be defined per programme, and certificates are issued from verified completion data.',
                'Can learners pay individually for open programmes?' => 'Yes. Individual learners can register and pay online, while corporate cohorts are invoiced to the sponsoring organisation.',
            ]),
        ],
    ...
    '/industries/continuing-education/' => [
        ...
        'lead'  => 'Lifelong learners enrol, pause and return over years. Acadlytic keeps one relationship record so each return is recognised and each next step is easy.',
        'blocks' => [
            ...
            faq([
                'Will a returning learner need to register again from scratch?' => 'No. Their existing record is recognised, so they confirm details rather than re-entering them, and their previous study remains visible.',
    ...
    '/industries/online-education/' => [
        ...
        'lead'  => 'When every interaction is digital, the administrative experience is the institution. Acadlytic helps online programmes recruit, enrol and support learners who may never visit campus.',
        'blocks' => [
            ...
            faq([
                'Does Acadlytic replace our LMS?' => 'No. Your LMS delivers teaching and learning. Acadlytic manages recruitment, records, fees, communication and support, and integrates with the LMS.',
                ...
                'Can we run multiple intakes a year?' => 'Yes. Programmes can have several start dates, each with its own deadlines and communication schedule.',
            ]),
        ],
    ...
    '/industries/multi-campus/' => [
        ...
        'blocks' => [
            ...
            faq([
                'Can each campus keep its own fee structures?' => 'Yes. Fees, calendars and programmes can be configured per campus while reporting definitions stay consistent across the group.',
                'Can a central admissions team work for several campuses?' => 'Yes. Shared teams can be given access to several campuses, while campus teams see only their own records.',
    ...
    '/industries/international-education/' => [
        ...
        'lead'  => 'Recruiting and supporting international students involves more parties, more documents and more deadlines. Acadlytic keeps them organised in one place.',
        'blocks' => [
            ...
            note('Acadlytic tracks visa-related milestones for planning and support. Visa decisions and immigration advice are outside its scope and remain with the relevant authorities and qualified advisors.'),
            faq([
                ...
                'Can applicants upload documents issued in other countries?' => 'Yes. Checklists can vary by country of qualification, and staff verify each document through the standard verification workflow.',
